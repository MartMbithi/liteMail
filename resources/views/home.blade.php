...
<div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href=""><img alt="logo" src="{{ url('assets/img/logo.svg') }}"> <span class="navbar-brand-name">{{ __('liteMail') }}</span></a>
            </div>
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <img src="{{ url('assets/img/profile-7.jpg') }}" class="img-fluid" alt="profile image">
            ...
            <nav id="topbr">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text">
                        <a href="{{ url('/home') }}" class="nav-link"> liteMail </a>
                    </li>
                </ul>
            </nav>
        </div>
