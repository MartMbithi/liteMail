        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <h1 class="">{{ __('Get started with a  free account') }}</h1>
                    <p class="signup-link">{{ __('Already have an account?') }} <a href="{{ route('login') }}">{{ __('Log in') }}</a></p>
                        ...
                        <div class="form">
                            ...
                            <div class="d-sm-flex justify-content-between">
                                ...
                                <div class="field-wrapper">
                                    <button type="submit" class="btn btn-primary" value="">{{ __('Get Started!') }}</button>
                                </div>
                            </div>
